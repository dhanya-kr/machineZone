...
MetronicApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        // Reports & Charts
        .state('jobsInQ', {
            url: "/jobs/jobs-inqueue.html",
            templateUrl: "views/jobs-inqueue.html",
            data: {
                pageTitle: 'Jobs in Queue'
            },
            controller: "JobsInQController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'MetronicApp',
                        ...
                        //Dynamic CSS files must be loaded between core and theme css files
                        files: [
                            'js/controllers/JobsInQController.js',
                            'js/services/mzStorage.js'
                        ]
                    });
                }]
        ...
        .state('jobsInProgress', {
            url: "/jobs/jobs-inprogress.html",
            templateUrl: "views/jobs-inprogress.html",
            data: {
                pageTitle: 'Jobs in Progress'
            },
            controller: "JobsInProgressController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'MetronicApp',
                        ...
                        //Dynamic CSS files must be loaded between core and theme css files
                        files: [
                            'js/controllers/JobsInProgressController.js',
                            'js/services/mzStorage.js'
                        ]
                    });
                }]
        ...
        // Reports & Charts
        .state('jobsSuccess', {
            url: "/jobs/jobs-success.html",
            templateUrl: "views/jobs-success.html",
            data: {
                pageTitle: 'Jobs Success'
            },
            controller: "JobsSuccessController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'MetronicApp',
                        ...
                        //Dynamic CSS files must be loaded between core and theme css files
                        files: [
                            'js/controllers/JobsSuccessController.js',
                            'js/services/mzStorage.js'
                        ]
                    });
                }]
        ...
        // Reports & Charts
        .state('jobsFailed', {
            url: "/jobs/jobs-failed.html",
            templateUrl: "views/jobs-failed.html",
            data: {
                pageTitle: 'Jobs Failed'
            },
            controller: "JobsFailedController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'MetronicApp',
                        ...
                        //Dynamic CSS files must be loaded between core and theme css files
                        files: [
                            'js/controllers/JobsFailedController.js',
                            'js/services/mzStorage.js'
                        ]
                    });
                }]
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        name: 'ui.select',
                        insertBefore: '#ng_load_plugins_before',
                        // load the above css files before '#ng_load_plugins_before'
                        files: [
